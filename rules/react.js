...
export default [
	{
		...
		rules: {
			...
			"react/forbid-component-props": "off", // Forbid certain props on Components (fixed typo from legacy config)
			...
			"react/no-danger-with-children": "error", // Prevent problems with children and dangerouslySetInnerHTML
			...
			"react/no-multi-comp": [ "error", { ignoreStateless: true } ], // Prevent multiple component definitions per file
			...
			"react/require-render-return": "error", // Enforce returning a value in render function
			...
			"react/sort-comp": [ "error", {
				...
				groups: {
					lux: [ "getActionGroup", "getActions", "stores" ],
			...
			"react/jsx-curly-spacing": [ "error", "always" ], // Enforce spaces inside of curly braces in JSX attributes
			"react/jsx-equals-spacing": [ "error", "never" ], // Enforce spaces around equal signs in JSX attributes (fixable)
			...
			"react/jsx-tag-spacing": "error", // Validate whitespace in and around the JSX brackets (fixable)
